...
* [리액트 강좌 사이트 - 더 로두 투 리액트(The Rorad To React)](https://roadtoreact.com/)


## 역자
이수진(Sujin Lee) @sujinleeme
* [github](github.com/sujinleeme) / [facebook](https://www.facebook.com/sujinlee.me) / [twitter](https://twitter.com/sujinleeme) / [instagram](https://www.instagram.com/sujinlee.me/)
...
실습 도중 문제가 생기면 깃허브 이슈로 알려주세요. 이슈를 게시할 때, 문제가 발생한 부분의 오류 로그 메시지, 스크린 샷, 책 페이지, 노드 버전를 함께 명시해주세요. 노드 버전은 커맨드 라인에 `node -v` 명령어로 확인하세요. 문제점을 자세히 알려주신다면 문제를 좀더 수월히 해결할 수 있습니다. 여러분들의 리뷰와 이슈는 콘텐츠를 개선하는데 큰 도움이 되고 있습니다.
