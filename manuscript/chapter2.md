# 리액트 기초 향상하기 / Basics in React

이번 장부터 본격적으로 리액트 개발을 시작하겠습니다. 정적인 컴포넌트보다 동적인 컴포넌트와 인터렉션을 구현해보면서 컴포넌트를 선언과 재사용이 가능한 컴포넌트를 배울 것입니다. 마지막으로 컴포넌트에 숨결을 불어넣어 생명체로 만들어 봅니다.
