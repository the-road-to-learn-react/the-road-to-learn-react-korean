...
**끝으로 바라는 점은?** 이 책을 읽기 전, 나와 리액트가 잘 맞는지 먼저 생각하는 시간을 가졌으면 한다. 리액트에 관심이 있거나, 리액트를 배우는 중이거나, 리액트를 배우고 싶지 않을 수도 있다. 주변에 있는 지인들과 함께 이 책을 읽기 바란다. 다른 사람들과 책을 공유하는 것은 나에게 굉장히 많은 것을 의미한다. 이 책은 다른 사람들과 함께 지식을 나누고자 만들어졌다.
